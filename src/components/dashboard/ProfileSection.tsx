  ...
  return (
    <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <div className="flex flex-wrap gap-3 mt-6">
        <button className="flex items-center bg-yellow-50 text-yellow-800 px-4 py-2 rounded-md text-sm font-medium">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          </svg>
          Track Progress
        </button>
        <button className="flex items-center bg-gray-100 text-gray-700 px-4 py-2 rounded-md text-sm font-medium">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
